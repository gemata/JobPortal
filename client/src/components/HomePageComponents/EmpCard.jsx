      ...
      <div className='container max-w-[1200px] mx-auto my-0 px-[15px]'>
        <div className='flex flex-col md:flex-row gap-4 mt-[100px] mb-[100px]'>
          <div className='bg-gray-100 p-6 rounded-lg flex-1'>
            ...
            <button className='bg-fuchsia-700 text-white px-4 py-2 rounded hover:bg-fuchsia-800' onClick={() => (window.location.href = 'http://localhost:5000/admin/login')}>
              Register Now →
            </button>
          </div>
          <div className='bg-fuchsia-700 p-6 rounded-lg text-white flex-1'>
            ...
            <button className='bg-white text-fuchsia-700 px-4 py-2 rounded hover:bg-gray-200' onClick={() => (window.location.href = 'http://localhost:5000/admin/login')}>
              Register Now →
            </button>
          </div>
        </div>
