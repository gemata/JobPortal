      ...
      <div className='container max-w-[1200px] mx-auto my-0 px-[15px]'>
        <div className='flex flex-col md:flex-row gap-4 mt-[100px] mb-[100px]'>
          <div className='bg-gray-100 p-6 rounded-lg flex-1'>
            ...
            <button className='bg-purple-500 text-white px-4 py-2 rounded hover:bg-purple-600' onClick={() => (window.location.href = 'http://localhost:5000/admin/login')}>
              Register Now →
            </button>
          </div>
          <div className='bg-purple-600 p-6 rounded-lg text-white flex-1'>
            ...
            <button className='bg-white text-purple-600 px-4 py-2 rounded hover:bg-gray-200' onClick={() => (window.location.href = 'http://localhost:5000/admin/login')}>
              Register Now →
            </button>
          </div>
        </div>
