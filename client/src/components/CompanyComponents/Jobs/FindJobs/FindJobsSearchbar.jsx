...
export default function FindJobsSearchbar({
  ...
  return (
    <>
      <div className='bg-white sticky top-0 shadow-lg w-full'>
        <form onSubmit={handleFormSubmit} className='relative w-full max-w-[1200px] mx-auto px-5 py-5'>
          <div className='flex'>
          ...
          <button onClick={toggleBorgir} className={`${jobOpened ? 'block' : 'hidden'} bg-jobportal-pink w-full absolute bottom-0 left-0 h-3`} type='button'></button>
        </form>
        <div className={`${jobOpened ? (isMenuOpen ? 'h-auto py-5' : 'h-0 overflow-hidden') : 'h-auto pb-5'} flex flex-wrap gap-3 w-full max-w-[1200px] mx-auto px-5`}>
          <select
            value={workLocation}
            onChange={handleWorkLocationChange}
            name='location'
            className='flex-shrink-0 z-10 flex-1 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 rounded-lg hover:bg-gray-200 focus:ring-jobportal-pink focus:border-jobportal-pink focus:outline-none'
          >
          ...
          <select
            ...
            name='companyList'
            className='flex-shrink-0 z-10 flex-1 inline-flex py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 rounded-lg hover:bg-gray-200 focus:ring-jobportal-pink focus:border-jobportal-pink focus:outline-none'
          >
