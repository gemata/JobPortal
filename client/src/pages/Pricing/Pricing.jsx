...
const PRICING_DATA = [
  {
    ...
    benefits: [
      "Essential job posting features and managing",
      "Access to candidate database with delete or ignore options",
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between mt-[50px] py-8 bg-white">
          <div className="max-w-xl text-center lg:text-left">
            ...
            <p className="mb-8 text-gray-700">
              Become an employer on our platform and the wide reach of qualified
              candidates, using our learning and intuitive treatment to post and
              manage your job announcements.
            </p>
          </div>
