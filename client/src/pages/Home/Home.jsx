          ...
          <div className="flex justify-between items-center">
            <div className="text-section">
              <h1 className="font-semibold text-[50px]">
                ...
                <span className="block leading-[0.8] mb-7 p-0">
                  your interest & skills.
                </span>
              </h1>
              <span className="text-base text-[#5e6670]">
                Aliquam vitae turpis in diam convillas finibus in at risus.
                Nullam{" "}
              ...
              <div className="flex items-center justify-center mt-5">
                <div className="flex items-center border rounded w-full max-w-[600px] p-[5px] border-solid border-[#ccc]">
                  ...
                  <input
                    type="text"
                    className="flex-1 text-base p-[5px] border-[none] bg-[#f1f2f4]"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {companies.map((company, index) => (
            ...
            >
              ...
              <div>
                <button className="w-full py-2 px-4 bg-blue-100 text-blue-500 font-medium rounded-md hover:bg-blue-200 transition-colors duration-300">
                  Open Position
                </button>
              </div>
            </div>
