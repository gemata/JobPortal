        ...
        <div className='max-w-[1200px] mx-auto my-0 px-[15px] py-0'>
          <div className='flex flex-col md:flex-row items-center justify-center min-h-screen p-6'>
            <div className='md:w-1/2 mb-8 md:mb-0'>
              ...
              <a href='mailto:jobhorizonsite@gmail.com' className='bg-jobportal-pink hover:bg-fuchsia-700 text-white px-6 py-3 rounded-md font-semibold'>
                Email Support
              </a>
            </div>
            <div className='md:w-1/2 bg-white p-8 rounded-md shadow-md'>
              ...
              <form className='space-y-4' onSubmit={handleSubmit}>
                <div>
                  <input type='text' name='name' placeholder='Name' className='w-full px-4 py-2 border border-gray-300 rounded-md' value={formData.name} onChange={handleChange} />
                </div>
                <div>
                  <input
                    type='email'
