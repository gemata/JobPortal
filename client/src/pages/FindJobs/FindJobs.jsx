...
const FindJobs = ({ userData }) => {
  ...
  const handleSaveClick = async () => {
    ...
    try {
      const response = fetch(`http://localhost:5000/api/savedjobs/`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      if (!response.ok) {
        console.error("Error in applicant list:", responseData.error);
  ...
  const handleLikeClick = async () => {
    ...
    try {
      const response = fetch(`http://localhost:5000/api/likedjobs/`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
                        ...
                        applied ? (
                          ...
                          <>
                            ...
                            <button
                              ...
                              className="bg-gray-200 hover:bg-gray-300 p-3 rounded-lg font-semibold"
                            >
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
