...
`;
  const Login = () => {
    ...
    }, "\xA9 Lab 2 2024. All rights reserved |", ' ', /*#__PURE__*/React__default.default.createElement("a", {
      href: "#",
      style: {
        color: '#3040d6',
        textDecoration: 'none'
  ...
  const SidebarFooter = () => {
    ...
    }, "Made with ", /*#__PURE__*/React__default.default.createElement("span", {
      style: {
        color: '#3040d6',
        fontWeight: 'bolder',
        fontSize: '20px'
